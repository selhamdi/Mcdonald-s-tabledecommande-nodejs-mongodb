//get all menu 
axios.get('http://localhost:3333/categorie')
.then(function (response) {
    ...
    response.data.forEach(element => {
        ...
        child += " <img src='/Front-end/app/image/tacos.jpg' alt='' style=' height: 120px;'>";
...
//get sous categorie
axios.get(`http://localhost:3333/sous_categorie/sous_categorie/${_id}`)
    .then(function (response) {
        ...
        response.data.forEach(element => {
            child += "<li>";
            child += "<div class='colun'>";
            child += " <img src='/Front-end/app/image/maxresdefault.jpg' alt='' style=' height: 120px;'>";
...
//get product avec id
    axios.get(`http://localhost:3333/product/id/${_id}`)
    .then(function (response) {
...
//get all sup 
    axios.get('http://localhost:3333/sup')
    .then(function (response) {
